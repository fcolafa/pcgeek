...
/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','validarVisita','admin','delete','index','view','obtenerSucursales','ExportPDF','InformesValorizados','VisitasNoValorizadas','Registros'),
				'expression'=>'$user->A1()',
			),
