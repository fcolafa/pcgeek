...
class MultilevelHorizontalMenu extends CWidget {
	...
	public function createMarkUp() {
		...
		$this -> _html .= '<div class="navbar-header">';
      	$this -> _html .= '<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#myslidemenu" aria-expanded="false">';
        $this -> _html .= '<span class="sr-only">Toggle navigation</span>';
      	$this -> _html .= '</button>';
      	$this -> _html .= '<a class="navbar-brand" href="#">Brand</a>';
    	$this -> _html .= '</div>';
		$this -> _html .= '<div class="collapse navbar-collapse" id="myslidemenu"> ';
		$this -> _html .= '<ul class="nav navbar-nav">';
		$this -> _createMenu($this -> _menu, 1);
		$this -> _html .= '</ul></div>';
		$this -> _html .= '</div><!-- /.container-fluid -->';
		$this -> _html .= '</nav>';
		echo $this -> _html;
	}
