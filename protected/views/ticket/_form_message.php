...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <div class="form-group">        
        ...
        <div class="col-md-5">
               ...
               <?php echo $form->textField($ticketm,'_verifyCode',array("class"=>"form-control")); ?>
               <?php echo $form->error($ticketm,'_verifyCode'); ?>
        </div>
</div>
        <div class="form-group">
	<div class="col-md-offset-4 col-sm-8">
		<?php echo CHtml::submitButton($ticketm->isNewRecord ? Yii::t('actions','Send') : Yii::t('actions','Save'),array('class'=>Yii::app()->params['btn btn-success'])); ?>
	</div>
        </div>
<?php $this->endWidget(); ?>
