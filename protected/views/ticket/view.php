...
<div class="panel panel-primary">
	<div class="panel-heading text-center"><h2> Detalle <?php echo Yii::t('database','Ticket')?> N°<?php echo $model->id_ticket." : ".$model->ticket_subject. $days  ?></h2></div>
...
//            ),
                 array(
                'name'=>'Nombre',
                'value'=>$model->idUser->NOMBRE_USUARIO.' ('.$model->idUser->iDCLIENTE->NOMBRE_CLIENTE.')',   
                ),
//              array(
//                'name'=>'Nombre',
//                'value'=>CHtml::link(
...
if(Yii::app()->user->A1()&& $model->ticket_status!="Cerrado"){
...
if(Yii::app()->user->C1()&& $model->ticket_status!="Cerrado"){
  echo CHtml::link('<div  class="messageButtonb blue">
